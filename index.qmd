...
## INITIALLY WHEN I RENDERED THE REPORT HAD ALL THE COMMENTS AND OUTPUTS THAT i DIN'T WANT INCLUDED IN THE FINAL REPORT SO I USED THIS CODE TO BLOCK THESE CHUNKS OF INSTRUCTIONS, COMMENTS AND CODE 
...
emissions_long_1990_2022 = emissions_long.query("year > 1989")
...
emissions_long_subset = emissions_long_1990_2022.query(
    'country == ("Tanzania","Kenya","Uganda","Burundi","Rwanda")'
)
...
fig_chart = px.line(
    ...
    y="emissions",
    color="country",
    title="CO2 Emissions for five East African countries (1990-2022)",
)
fig_chart
```
...
This is a Quarto visualization report of Global CO2 emissions over time (1800-2022).The table shows emissions between 2000 and 2022 as well as the absolute and relative changes between these years, a line plot illustrates CO2 Emissions for five East African countries between 1990 and 2022 and a choropleth map showcases global CO2 Emissions between 1990 and 2022. This was done using the Gapminder dataset, Plotly, and itables.
